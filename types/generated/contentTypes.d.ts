...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    aboutSectionName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    contactLink: Schema.Attribute.Component<'molecule.contact-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    contactSectionName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    >;
    photosPreview: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    skills: Schema.Attribute.Component<'card.skill', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    skillSectionName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiTechnologyTechnology extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['frontend', 'backend', 'database', 'design', 'cloud']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    timeline_items: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiTimelineItemTimelineItem
  ...
  attributes: {
    badge: Schema.Attribute.DynamicZone<
      ['molecule.image', 'molecule.lucide-icon']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    type: Schema.Attribute.Enumeration<
      ['experience', 'education', 'certification', 'freelance']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
