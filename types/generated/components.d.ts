...
export interface MoleculeImage extends Struct.ComponentSchema {
  collectionName: 'components_molecule_images';
  info: {
    displayName: 'image';
    icon: 'crop';
  };
...
export interface MoleculeLucideIcon extends Struct.ComponentSchema {
  collectionName: 'components_molecule_lucide_icons';
  info: {
    description: '';
    displayName: 'lucideIcon';
    icon: 'alien';
  };
  attributes: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      ...
      'molecule.image': MoleculeImage;
      'molecule.lucide-icon': MoleculeLucideIcon;
    }
  }
}
